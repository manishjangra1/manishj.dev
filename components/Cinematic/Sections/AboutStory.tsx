...
const AboutStory: React.FC = () => {
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center p-6 md:p-12 lg:p-24 pointer-events-none overflow-hidden">
      {/* Scrollable Container (Hidden Scrollbar) */}
      <div className="w-full max-w-7xl h-full max-h-[85vh] pointer-events-auto overflow-y-auto scrollbar-hide pb-32 pt-12 md:pb-40">
