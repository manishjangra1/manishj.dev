...
export function HeroSection({
  ...
  return (
    <section
      ...
      className={cn(
        'pt-10 sm:pt-14 md:pt-16 lg:pt-8 xl:pt-10 pb-8 sm:pb-12 lg:pb-8 lg:min-h-[calc(100dvh-64px-42px)] flex flex-col lg:justify-center',
        className
      )}
    >
      <Container well="wide">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-10 lg:gap-x-8 xl:gap-x-12 items-center">
          ...
          <div className="w-full lg:col-span-6 flex flex-col items-start">
            ...
            <h1 className="mt-[16px] sm:mt-[20px] text-[32px] sm:text-[44px] md:text-[54px] lg:text-[60px] font-bold leading-[1.05] tracking-[-0.035em] text-[var(--color-text)] text-balance">
              {name}
            </h1>

            <p className="mt-[20px] sm:mt-[24px] max-w-[32em] lg:max-w-[28em] text-[15px] sm:text-[16px] leading-[1.55] text-[var(--color-text-secondary)] text-pretty">
              {lede}
            </p>

            {/* Action Buttons */}
            <div className="mt-[28px] sm:mt-[32px] flex flex-wrap items-center gap-3.5 w-full sm:w-auto">
              <Button
                href={primary.href}
                variant="primary"
                size="md"
            ...
            {availability && (
              <div className="mt-[24px] sm:mt-[28px] flex items-center gap-2.5 select-none">
            ...
            {/* Key Metrics Bar */}
            <div className="mt-[28px] sm:mt-[34px] w-full">
