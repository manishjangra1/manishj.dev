...
export const PROJECT_ROWS: ProjectRowData[] = [
  {
    year: '2025',
    title: 'Servyq',
    slug: 'servyq',
    summary: 'Dual-role mobile marketplace with real-time technician tracking, escrow payments, and automated dispatch.',
    meta: ['React Native', 'NestJS', 'PostgreSQL'],
    imageSrc: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=1280&auto=format&fit=crop',
    imageAlt: 'Servyq dashboard interface',
    liveUrl: 'https://servyq.com',
    repoUrl: 'https://github.com/manishjangra1/servyq',
  },
  {
    ...
    title: 'Dayzo',
    slug: 'dayzo',
    summary: 'Social habit-tracking platform with streaks, analytics, and smart reminders.',
    meta: ['Next.js', 'MongoDB', 'Tailwind CSS'],
    imageSrc: 'https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?q=80&w=1280&auto=format&fit=crop',
    imageAlt: 'Dayzo analytics dashboard',
    liveUrl: 'https://dayzo.app',
    repoUrl: 'https://github.com/manishjangra1/dayzo',
  },
  {
    ...
    title: 'Portfolio & CMS',
    slug: 'portfolio',
    summary: 'Custom portfolio CMS with a headless architecture and role-based access control.',
    meta: ['Next.js', 'PostgreSQL', 'Redis'],
    imageSrc: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=1280&auto=format&fit=crop',
    imageAlt: 'Portfolio management CMS',
    liveUrl: 'https://manishj.dev',
    repoUrl: 'https://github.com/manishjangra1/portfolio',
  },
];
